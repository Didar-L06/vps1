...
tgid="-1001683718191"  # ID чата для автобэкапа (Необходим доступ к сообщениям)
tg2id="-1001683718191" # ID чата диллерской группы для отправки ключей
admls="5222825196"	   # ID Админа
bot_api="5217693677:AAGwT24ZgSvfn5bH1VC0t_5IpE35zyAmmrE" # Токен бота 
